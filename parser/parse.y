...
old_lambdef // Used in: old_test
	...
	;
test // Used in: opt_EQUAL_test, print_stmt, opt_test, raise_stmt, opt_COMMA_test, opt_test_3, exec_stmt, assert_stmt, if_stmt, star_ELIF, while_stmt, with_item, except_clause, opt_AS_COMMA, opt_IF_ELSE, listmaker, testlist_comp, lambdef, subscript, opt_test_only, sliceop, testlist, dictorsetmaker, argument, testlist1, star_COMMA_test, star_test_COLON_test, plus_COMMA_test, dictarg, listarg
	: or_test opt_IF_ELSE
	| lambdef
	;
...
comp_iter // Used in: comp_for, comp_if
	...
	| comp_if
	;
comp_for // Used in: testlist_comp, pick_comp_for, pick_for_test, opt_comp_for, comp_iter
